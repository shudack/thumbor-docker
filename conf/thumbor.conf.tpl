...
## Defaults to: Thumbor/7.0.0
HTTP_LOADER_DEFAULT_USER_AGENT = '{{ HTTP_LOADER_DEFAULT_USER_AGENT | default('Thumbor/7.0.0') }}'
...
########################### THUMBOR_AWS ########################################
AWS_LOADER_REGION_NAME = '{{ AWS_LOADER_REGION_NAME | default('eu-west-1') }}' # AWS Region
AWS_STORAGE_REGION_NAME = '{{ AWS_STORAGE_REGION_NAME | default('eu-west-1') }}' # AWS Region
AWS_LOADER_BUCKET_NAME = '{{ AWS_LOADER_BUCKET_NAME | default('1') }}'
...
IMGIX_COMPAT_TOKEN = '{{ IMGIX_COMPAT_TOKEN | default('') }}'
IMGIX_COMPAT_STORAGE_ROOT = '{{ IMGIX_COMPAT_STORAGE_ROOT | default('') }}'
IMGIX_COMPAT_AUTO_QUALITY = {{ IMGIX_COMPAT_AUTO_QUALITY | default(95) }}